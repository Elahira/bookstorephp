                            ...
                            <div class="card-body">
                                ...
                                <form action="./inc/process.php?addt_user" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" id="val-phoneus" name="phone" placeholder="19008080" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            <input type="password" class="form-control" id="val-confirm-password" name="val-confirm-password" placeholder="Repeat password" required>
                                        </div>
                                    </div>
